...
namespace ecms.Application.Handlers.Commands.EditMaterial;

public class EditMaterialCommandValidator : AbstractValidator<EditMaterialCommand>
{
    ...
    public EditMaterialCommandValidator()
    {
        RuleFor(p => p.Name)
        ...
        RuleFor(p => p.MaterialId)
            .NotEmpty().WithErrorCode(MaterialErrorCodes.MissingId);
    }
}
