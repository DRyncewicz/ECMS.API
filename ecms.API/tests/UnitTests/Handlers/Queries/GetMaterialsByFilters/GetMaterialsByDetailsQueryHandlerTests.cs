...
namespace UnitTests.Handlers.Queries.GetMaterialsByFilters;

public class GetMaterialsByDetailsQueryHandlerTests : IClassFixture<MappingTestFixture>
{
    ...
    public GetMaterialsByDetailsQueryHandlerTests(MappingTestFixture fixture)
    {
